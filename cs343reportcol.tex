...
One might hope that such an important protocol adheres to the canonical computer security principles of \textbf{C.I.A.}\footnote{\textbf{Confidentiality:} Only authorized parties should be able to view data; \textbf{Integrity:} Data should not be altered in any unauthorized fashion; \textbf{Availability:} Data should be available to and modifiable by authorized individuals.}. DNS lookups, however, do not 
